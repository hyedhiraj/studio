...
export default function ProblemSolvingPage() {
  ...
  const methodology = "Problem Solving Process";
  ...
  useEffect(() => {
    ...
    setMessages([{
      id: "init",
      text: `Welcome to the ${methodology}! How can I help you define problems, analyze root causes, or develop effective solutions?`,
      sender: "ai"
    }]);
  }, []);
    ...
    <div className="container mx-auto py-8 px-4">
      <header className="mb-8 text-center">
        <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl flex items-center justify-center">
          <Lightbulb className="h-8 w-8 mr-2 text-accent" />
          Problem Solving Process
        </h1>
        <p className="mt-2 text-lg text-muted-foreground">
          Systematically identify, analyze, and resolve issues for continuous improvement.
        </p>
      </header>

      <Card className="w-full max-w-3xl mx-auto shadow-xl">
        <CardHeader>
          <CardTitle>Problem Solving Chat</CardTitle>
          <CardDescription>Seek AI guidance for your problem-solving journey. Ask about tools like 5 Whys, Fishbone Diagrams, or PDCA cycle.</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
          <form onSubmit={handleSubmit} className="flex w-full items-center space-x-2">
            <Input
              type="text"
              placeholder="Ask about Problem Solving..."
              value={userInput}
